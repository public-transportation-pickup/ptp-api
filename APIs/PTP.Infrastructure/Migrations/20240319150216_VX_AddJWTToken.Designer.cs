...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240319150216_VX_AddJWTToken")]
    partial class VX_AddJWTToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0f20a48a-6988-49d2-b339-d864f91c0c45"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 19, 22, 2, 16, 561, DateTimeKind.Local).AddTicks(552),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("9088829a-4c9a-4588-8717-b555ef921635"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 19, 22, 2, 16, 561, DateTimeKind.Local).AddTicks(582),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("3782e3b9-331d-4002-94dc-9359482b8eb4"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 19, 22, 2, 16, 561, DateTimeKind.Local).AddTicks(584),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("53fb87d8-52b6-411a-aae6-a9dab02b31a1"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 19, 22, 2, 16, 561, DateTimeKind.Local).AddTicks(587),
                            IsDeleted = false,

            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4f752f8a-b084-497c-a4af-719255095066"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 22, 48, 12, 915, DateTimeKind.Local).AddTicks(621),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("87f2a8af-fcaf-45c7-a1d0-a511d5184279"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 22, 48, 12, 915, DateTimeKind.Local).AddTicks(638),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("9e11d9c0-8c98-4c77-9478-367a1384b2dd"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 22, 48, 12, 915, DateTimeKind.Local).AddTicks(640),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("0d357a4d-e8bc-407d-855e-5d16bc9fdf52"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 22, 48, 12, 915, DateTimeKind.Local).AddTicks(642),
                            IsDeleted = false,

...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240113040744_V3_ChangeDatatypeForLocation")]
    partial class V3_ChangeDatatypeForLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTP.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<Guid>("ProductInMenuId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7fe9b7dd-5461-4d18-8d7e-9836e881ec12"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 13, 11, 7, 44, 805, DateTimeKind.Local).AddTicks(6555),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("4a09fd7e-8818-4a02-81df-8b3a75a90b57"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 13, 11, 7, 44, 805, DateTimeKind.Local).AddTicks(6577),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("72cce70a-9124-4d94-a278-f4993e8983b2"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 13, 11, 7, 44, 805, DateTimeKind.Local).AddTicks(6621),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("bf286d85-b289-4344-a20b-c26858acf844"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 13, 11, 7, 44, 805, DateTimeKind.Local).AddTicks(6623),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("PTP.Domain.Entities.StoreType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Store", b =>
                {
                    b.HasOne("PTP.Domain.Entities.StoreType", null)
                        .WithMany("Stores")

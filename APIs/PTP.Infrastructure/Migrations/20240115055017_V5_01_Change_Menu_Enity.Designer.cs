...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240115055017_V5_01_Change_Menu_Enity")]
    partial class V5_01_Change_Menu_Enity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("21e82a5c-4d04-4f27-b3fb-f88005283b43"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 50, 16, 794, DateTimeKind.Local).AddTicks(3774),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("5ccc72a1-39e4-4d17-a6c0-01424df7b8d6"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 50, 16, 794, DateTimeKind.Local).AddTicks(3795),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("8bfdca7e-993e-44db-aeeb-2a5b2bdd08fb"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 50, 16, 794, DateTimeKind.Local).AddTicks(3810),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("8ab68ae6-4bfa-4b66-9b84-e1e832a214b1"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 50, 16, 794, DateTimeKind.Local).AddTicks(3813),
                            IsDeleted = false,

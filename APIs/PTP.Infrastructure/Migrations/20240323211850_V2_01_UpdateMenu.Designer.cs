...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240323211850_V2_01_UpdateMenu")]
    partial class V2_01_UpdateMenu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("af6dd891-df8b-4271-839a-49d911b3fc14"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 24, 4, 18, 49, 802, DateTimeKind.Local).AddTicks(1976),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("987179c7-d0d4-401e-aef1-007ec9735616"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 24, 4, 18, 49, 802, DateTimeKind.Local).AddTicks(1995),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("5b45d1a5-b434-4f2d-9070-578d0458b171"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 24, 4, 18, 49, 802, DateTimeKind.Local).AddTicks(1998),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("7f4dfffc-adaf-491e-b39e-019e854596d7"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 3, 24, 4, 18, 49, 802, DateTimeKind.Local).AddTicks(2000),
                            IsDeleted = false,

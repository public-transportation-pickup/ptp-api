...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240115055110_V5_02_Update_Menu_Start_End")]
    partial class V5_02_Update_Menu_Start_End
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1d8ca625-bb3c-42dc-8fdb-2372928c4c72"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 51, 9, 946, DateTimeKind.Local).AddTicks(5278),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("5f676b28-fda8-462b-8e32-eed53dc07f01"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 51, 9, 946, DateTimeKind.Local).AddTicks(5301),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("3b1ccf79-0768-438c-8836-63d74559fe64"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 51, 9, 946, DateTimeKind.Local).AddTicks(5303),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("201319ab-0d25-4795-92b8-7ffa2f998169"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 1, 15, 12, 51, 9, 946, DateTimeKind.Local).AddTicks(5306),
                            IsDeleted = false,

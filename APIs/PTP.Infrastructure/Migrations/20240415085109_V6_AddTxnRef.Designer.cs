...
namespace PTP.Infrastructure.Migrations
{
    ...
    [Migration("20240415085109_V6_AddTxnRef")]
    partial class V6_AddTxnRef
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PTP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("92b59f42-64ca-4fd4-b008-f327a61d159e"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 15, 51, 8, 773, DateTimeKind.Local).AddTicks(5775),
                            IsDeleted = false,
                            Name = "StoreManager"
                        },
                        new
                        {
                            Id = new Guid("02cd17aa-c955-44ae-921c-8f6a4af5761d"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 15, 51, 8, 773, DateTimeKind.Local).AddTicks(5847),
                            IsDeleted = false,
                            Name = "Customer"
                        },
                        new
                        {
                            Id = new Guid("13e4c4db-8e74-41d9-b499-e748841305b1"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 15, 51, 8, 773, DateTimeKind.Local).AddTicks(5853),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("181a36ea-d8d0-4095-bd98-46737b36b83c"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreationDate = new DateTime(2024, 4, 15, 15, 51, 8, 773, DateTimeKind.Local).AddTicks(5856),
                            IsDeleted = false,

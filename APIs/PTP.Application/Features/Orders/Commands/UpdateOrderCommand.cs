        ...
        public class CommandHandler : IRequestHandler<UpdateOrderCommand, bool>
        {
            ...
            private async Task CreateTransaction(Order order)
            {
                ...
                var transactions= new List<Transaction>{
                    ...
                    new Transaction{Name=nameof(TransactionTypeEnum.Transfer),Amount=order.Total,TransactionType=nameof(TransactionTypeEnum.Receive),WalletId=storeWallet.Id,PaymentId=order.PaymentId}
                };

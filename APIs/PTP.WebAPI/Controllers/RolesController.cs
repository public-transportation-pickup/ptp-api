...
public class RolesController : BaseController
{
    ...
    */
    ...
    [HttpGet("{id}")]
    public async Task<IActionResult> TestNotify(int id, [FromQuery] string token)
    {
        ...
        await FirebaseUtilities.SendNotification(token, "Test", "Test message", _appSettings.FirebaseSettings.SenderId, _appSettings.FirebaseSettings.ServerKey);
        return Ok();
    }
